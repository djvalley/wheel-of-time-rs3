...
import net.wheeloftime.network.decoders.LoginServerPacketsDecoder;
		...
		for (int i = 0; i < amount; i++) {
			...
			if (packet.getLength() < 9
					...
					|| !Arrays.equals(world.getLoginAddress().getAddress()
							.getAddress(), packet.getAddress().getAddress())) {
					Logger.log(LoginServerChannelManager.class,
							"Game->Login packet was rejected - excepting: "+world.getLoginAddress()+" receiving: "+packet.getAddress());
				continue; // discard it
			}

...
import net.wheeloftime.game.npc.DropTable;
import net.wheeloftime.game.npc.NPC;
import net.wheeloftime.game.npc.clans.ClanVexillum;
import net.wheeloftime.game.npc.familiar.Familiar;
import net.wheeloftime.game.npc.familiar.impl.Pyrelord;
import net.wheeloftime.game.npc.others.ConditionalDeath;
import net.wheeloftime.game.npc.others.FireSpirit;
...
import net.wheeloftime.game.npc.others.Pet;
...
import net.wheeloftime.game.player.FarmingManager.ProductInfo;
...
import net.wheeloftime.game.player.actions.Rest;
...
import net.wheeloftime.game.player.actions.skills.dungeoneering.DungeonRewardShop;
import net.wheeloftime.game.player.actions.skills.dungeoneering.rooms.puzzles.ColouredRecessRoom.Block;
import net.wheeloftime.game.player.actions.skills.dungeoneering.rooms.puzzles.SlidingTilesRoom;
import net.wheeloftime.game.player.actions.skills.farming.FarmingStore;
import net.wheeloftime.game.player.actions.skills.fishing.Fishing;
import net.wheeloftime.game.player.actions.skills.fishing.Fishing.FishingSpots;
import net.wheeloftime.game.player.actions.skills.herblore.Herblore.CleanAction;
import net.wheeloftime.game.player.actions.skills.hunter.FlyingEntityHunter;
import net.wheeloftime.game.player.actions.skills.magic.Magic;
import net.wheeloftime.game.player.actions.skills.mining.LivingMineralMining;
import net.wheeloftime.game.player.actions.skills.mining.MiningBase;
import net.wheeloftime.game.player.actions.skills.mining.SaltyCrabletineMining;
...
import net.wheeloftime.game.player.actions.skills.slayer.SlayerShop;
...
import net.wheeloftime.game.player.actions.skills.thieving.PickPocketAction;
import net.wheeloftime.game.player.actions.skills.thieving.PickPocketableNPC;
import net.wheeloftime.game.player.actions.skills.thieving.PrifddinasPickpocketing;
import net.wheeloftime.game.player.content.AbbysObsticals;
import net.wheeloftime.game.player.content.CarrierTravel;
import net.wheeloftime.game.player.content.CarrierTravel.Carrier;
import net.wheeloftime.game.player.content.GnomeGlider;
import net.wheeloftime.game.player.content.PlayerLook;
import net.wheeloftime.game.player.content.RecipeShop;
import net.wheeloftime.game.player.content.SheepShearing;
...
import net.wheeloftime.game.player.content.activities.minigames.SorceressGarden;
import net.wheeloftime.game.player.content.activities.minigames.pest.CommendationExchange;
import net.wheeloftime.game.player.controllers.RuneEssenceController;
import net.wheeloftime.game.player.dialogues.impl.BoatingDialouge;
import net.wheeloftime.game.player.dialogues.impl.FremennikShipmaster;
import net.wheeloftime.game.player.dialogues.impl.cities.taverly.PetShopOwner;
	...
	public static void handleOption1(final Player player, final InputStream stream) {
		...
		player.setRouteEvent(new RouteEvent(npc, () -> {
			...
			case 14364: // greegreeshop
				...
				break;
			case 945:
				player.getDialogueManager().startDialogue("Ironnpc");
				break;
			...
			if (shipAttributes != null)
				...
				player.getDialogueManager().startDialogue("Scribe", npc.getId(), 20708);
				...
				ClanVexillum.openPlayerClanDetails(player);
				...
				player.getDialogueManager().startDialogue("Nastroth", npc.getId());
				...
				player.getDialogueManager().startDialogue("KilnCapeTrade", npc.getId());
				...
				player.getDialogueManager().startDialogue("Kolodion", npc.getId());

...
import net.wheeloftime.game.item.actions.MonkeyGreeGrees;
import net.wheeloftime.game.map.MapBuilder;
import net.wheeloftime.game.map.MapUtils;
import net.wheeloftime.game.map.MapUtils.Structure;
import net.wheeloftime.game.npc.NPC;
import net.wheeloftime.game.npc.agoroth.Agoroth;
import net.wheeloftime.game.npc.araxxi.Araxxi;
import net.wheeloftime.game.npc.corp.CorporealBeast;
import net.wheeloftime.game.npc.dagannoth.DagannothFledgeling;
import net.wheeloftime.game.npc.dagannoth.DagannothKing;
import net.wheeloftime.game.npc.dragons.FrostDragon;
import net.wheeloftime.game.npc.dragons.KingBlackDragon;
import net.wheeloftime.game.npc.evilchicken.EvilChicken;
import net.wheeloftime.game.npc.glacior.Glacor;
...
import net.wheeloftime.game.npc.godwars2.SerenFaction;
import net.wheeloftime.game.npc.godwars2.SliskeFaction;
import net.wheeloftime.game.npc.godwars2.ZamorakFaction;
import net.wheeloftime.game.npc.godwars2.ZarosFaction;
import net.wheeloftime.game.npc.godwars2.gregorovic.Gregorovic;
import net.wheeloftime.game.npc.godwars2.gregorovic.Shadow;
import net.wheeloftime.game.npc.godwars2.gregorovic.Spirit;
import net.wheeloftime.game.npc.godwars2.helwyr.CywirAlpha;
import net.wheeloftime.game.npc.godwars2.helwyr.Helwyr;
import net.wheeloftime.game.npc.godwars2.twinfuries.Avaryss;
import net.wheeloftime.game.npc.godwars2.twinfuries.Nymora;
import net.wheeloftime.game.npc.godwars2.vindictagorvek.Gorvek;
import net.wheeloftime.game.npc.godwars2.vindictagorvek.Vindicta;
import net.wheeloftime.game.npc.kalphite.KalphiteKing;
import net.wheeloftime.game.npc.kalphite.KalphiteQueen;
import net.wheeloftime.game.npc.lucien.Lucien;
import net.wheeloftime.game.npc.nomad.FlameVortex;
import net.wheeloftime.game.npc.nomad.Nomad;
import net.wheeloftime.game.npc.others.AbyssalDemon;
import net.wheeloftime.game.npc.others.BanditCampBandits;
import net.wheeloftime.game.npc.others.BlackDemon;
import net.wheeloftime.game.npc.others.ChaosElemental;
import net.wheeloftime.game.npc.others.ConditionalDeath;
import net.wheeloftime.game.npc.others.Cyclopse;
import net.wheeloftime.game.npc.others.DoorSupport;
import net.wheeloftime.game.npc.others.Ducks;
import net.wheeloftime.game.npc.others.Elemental;
import net.wheeloftime.game.npc.others.HarpieBug;
import net.wheeloftime.game.npc.others.HoleInTheWall;
import net.wheeloftime.game.npc.others.HunterTrapNPC;
import net.wheeloftime.game.npc.others.Jadinko;
import net.wheeloftime.game.npc.others.Kurask;
import net.wheeloftime.game.npc.others.Legio;
import net.wheeloftime.game.npc.others.LivingRock;
import net.wheeloftime.game.npc.others.MasterOfFear;
import net.wheeloftime.game.npc.others.MaxTheMaxed;
import net.wheeloftime.game.npc.others.MercenaryMage;
import net.wheeloftime.game.npc.others.MutatedZygomites;
import net.wheeloftime.game.npc.others.Nechryael;
import net.wheeloftime.game.npc.others.PolyporeCreature;
import net.wheeloftime.game.npc.others.Revenant;
import net.wheeloftime.game.npc.others.RockCrabs;
import net.wheeloftime.game.npc.others.SaltyCrabletine;
import net.wheeloftime.game.npc.others.Sheep;
import net.wheeloftime.game.npc.others.SkillAlchemistNPC;
import net.wheeloftime.game.npc.others.Strykewyrm;
import net.wheeloftime.game.npc.others.TheDarkOracle;
import net.wheeloftime.game.npc.others.TormentedDemon;
import net.wheeloftime.game.npc.others.Werewolf;
import net.wheeloftime.game.npc.others.WildyWyrm;
...
import net.wheeloftime.game.npc.riseofthesix.Torag;
import net.wheeloftime.game.npc.riseofthesix.Verac;
import net.wheeloftime.game.npc.slayer.Airut;
import net.wheeloftime.game.npc.vorago.Vorago;
import net.wheeloftime.game.npc.vorago.VoragoHandler;
import net.wheeloftime.game.npc.vorago.VoragoMinion;
import net.wheeloftime.game.player.ActionBar;
import net.wheeloftime.game.player.CombatDefinitions;
import net.wheeloftime.game.player.OwnedObjectManager;
import net.wheeloftime.game.player.Player;
import net.wheeloftime.game.player.Skills;
import net.wheeloftime.game.player.actions.Healing;
import net.wheeloftime.game.player.actions.skills.divination.Wisp;
import net.wheeloftime.game.player.actions.skills.divination.WispInfo;
import net.wheeloftime.game.player.actions.skills.hunter.TrapAction.HunterNPC;
import net.wheeloftime.game.player.actions.skills.prayer.Prayer;
import net.wheeloftime.game.player.actions.skills.runecrafting.SiphonActionNodes;
import net.wheeloftime.game.player.content.LivingRockCavern;
import net.wheeloftime.game.player.content.Lottery;
import net.wheeloftime.game.player.content.activities.XPWell;
import net.wheeloftime.game.player.content.activities.clans.ClansManager;
import net.wheeloftime.game.player.content.activities.distractions.EvilTree;
import net.wheeloftime.game.player.content.activities.distractions.PenguinHS;
import net.wheeloftime.game.player.content.activities.events.GlobalEvents;
import net.wheeloftime.game.player.content.activities.events.WorldEvents;
import net.wheeloftime.game.player.content.activities.minigames.GodWarsBosses;
import net.wheeloftime.game.player.content.activities.minigames.PuroPuro;
...
import net.wheeloftime.game.player.content.activities.minigames.duel.DuelController;
import net.wheeloftime.game.player.content.activities.minigames.fistofguthix.MinigameManager;
import net.wheeloftime.game.player.content.activities.minigames.soulwars.SoulLobby;
import net.wheeloftime.game.player.content.activities.minigames.soulwars.SoulWars;
import net.wheeloftime.game.player.content.activities.minigames.warbands.Warbands;
import net.wheeloftime.game.player.content.activities.minigames.warbands.Warbands.WarbandEvent;
...
import net.wheeloftime.game.player.controllers.JadinkoLair;
import net.wheeloftime.game.player.controllers.Wilderness;
import net.wheeloftime.game.route.Flags;
...
import net.wheeloftime.utils.sql.Exchange;
import net.wheeloftime.utils.sql.HighscoresManager;
...
public final class World {
	...
	/**
	 * Skill id for skill id. MODIFIER is divided by ten, so that it's rounded
	...
	private static void addSkillerDreamTask() {
		GameExecutorManager.slowExecutor.scheduleWithFixedDelay(new Runnable() {
			...
			public void run() {
				...
				if (MODIFIER == 10) {
					sendWorldMessage(
							"<img=7><col=FFA500>[Skiller's Dream] The xp bonus for "
					...
					sendWorldMessage("<img=7><col=FFA500>[Skiller's Dream] "
							+ godName + " has granted everyone a "
							+ (MODIFIER / 10) + "X xp bonus for " + skillName
							+ "!", false);
					if (Settings.HOSTED)
						Engine.getDiscordBot()
								.getChannel("264440233129541632")
								.sendMessage(
										"[Skiller's Dream]  " + godName
												+ " has granted everyone a "
												+ (MODIFIER / 10)
												+ "X xp bonus for " + skillName
												+ "!");
				}
			}
		}, 1, 4, TimeUnit.HOURS);
	...
	private static void addVoragoTask() {
	...
	public static boolean[] harmonizedRock = new boolean[4];

	private static void addHarmonizedRocksTask() {
		GameExecutorManager.slowExecutor.scheduleWithFixedDelay(new Runnable() {
			@Override
			public void run() {
				for (int i = 0; i <= 3; i++)
					harmonizedRock[i] = false;
				int rockIndex = Utils.random(0, 3);
				harmonizedRock[rockIndex] = true;
				String rockName = null;
				switch (rockIndex) {
				case 0:
					rockName = "coal";
					WorldEvents.HARMONIZED_STATUS = "Coal rocks in Prifddinas are currently harmonized!";
					break;
				case 1:
					rockName = "mithril";
					WorldEvents.HARMONIZED_STATUS = "Mithril rocks in Prifddinas are currently harmonized!";
					break;
				case 2:
					rockName = "adamantite";
					WorldEvents.HARMONIZED_STATUS = "Adamantite rocks in Prifddinas are currently harmonized!";
					break;
				case 3:
					rockName = "runite";
					WorldEvents.HARMONIZED_STATUS = "Runite rocks in Prifddinas are currently harmonized!";
					break;
				}
				World.sendWorldMessage(
						"<img=6><col=FFA500><shad=000000>The "
								+ rockName
								+ " rocks at Prifddinas have become harmonized, mine them for bonus ores!",
						false);
			}
		}, 0, 1, TimeUnit.HOURS);
	}
	...
	private static void addWarbandsEventManager() {
		...
		}, Utils.random(45, 200), 180, TimeUnit.MINUTES);
	}
	...
	private static void addDatabaseTask() {
		GameExecutorManager.slowExecutor.scheduleWithFixedDelay(new Runnable() {
			@Override
			public void run() {
				try {
	...
	private static void addPenguinsTask() {
		GameExecutorManager.slowExecutor.scheduleWithFixedDelay(new Runnable() {
			@Override
			public void run() {
				try {
					for (final Player player : World.getPlayers()) {
						...
						player.getTemporaryAttributtes()
								.put(Key.PENGUIN, false);
					}
					for (final NPC n : World.getNPCs()) {
						if (n == null)
							continue;
						else if ((n.getId() >= 8104 && n.getId() <= 8110)
								|| n.getId() == 14766 || n.getId() == 14415)
							n.sendDeath(n);
					}
		...
		}, Utils.random(1, 2), 2, TimeUnit.HOURS);
	}
	...
	private static final void adddrainTask() {
		GameExecutorManager.fastExecutor.schedule(new TimerTask() {
			@Override
			public void run() {
				try {
			...
			public void run() {
				try {
					for (Player player : getPlayers()) {
						if (player == null || !player.isRunning())
							continue;
						int ammountTimes = player.getPrayer().isActive(
								Prayer.RAPID_RESTORE) ? 2 : 1;
						if (player.isResting())
							ammountTimes += 1;
						boolean berserker = player.getPrayer().isActive(
								Prayer.BERSERKER);
	...
	public static final NPC spawnNPC(int id, WorldTile tile,
			...
			boolean spawned, boolean instance) {
		NPC n = null;
		if (id == 6261 || id == 6263 || id == 6265)
			if (instance)
				n = new GodWarMinion(id, 0, tile, mapAreaNameHash,
	...
	public static final NPC spawnNPC(int id, WorldTile tile,
		...
		if (id >= 5533 && id <= 5558)
			n = new Elemental(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 18538 || id == 18539)
			n = new Ahrim(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 18540)
			n = new Dharok(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 18541 || id == 18542)
			n = new Guthan(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 18543)
			n = new Karil(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 18544)
			n = new Torag(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 18545)
			n = new Verac(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 23374)
			n = new SaltyCrabletine(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea);
		else if (id == 46 || id == 2693 || id == 6133)
			n = new Ducks(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea);
		else if (id == 2880)
			n = new DagannothFledgeling(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
			...
			n = new Agoroth(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 17149 || id == 17150 || id == 17151 || id == 17152
				|| id == 17153 || id == 17154)
			n = new Legio(null, mapAreaNameHash);
			...
			n = new HunterTrapNPC(HunterNPC.TORTLE, id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 7010 || id == 7011)
			n = new HunterTrapNPC(HunterNPC.GRENWALL, id, tile,
					mapAreaNameHash, canBeAttackFromOutOfArea, spawned);
		else if (id == 19443)
		...
		else if (id >= 22470 && id <= 22474)
			n = new SerenFaction(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id >= 22478 && id <= 22484)
			n = new SliskeFaction(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id >= 22486 && id <= 22494)
			n = new ZamorakFaction(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id >= 22496 && id <= 22501)
			n = new ZarosFaction(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 1615)
			...
			n = new Vindicta(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 22463)
			n = new Gorvek(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 22455)
			n = new Avaryss(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 22456)
			n = new Nymora(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 22443)
			n = new Gregorovic(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else if (id == 22444)
			n = new Shadow(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 22450)
			n = new Spirit(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 22438)
			n = new Helwyr(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
		else if (id == 22439)
			n = new CywirAlpha(id, tile, mapAreaNameHash,
					canBeAttackFromOutOfArea, spawned);
		else {
			n = new NPC(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea,
					spawned);
	...
	private static void checkControllersAtMove(Player player) {
		MonkeyGreeGrees.checkMovement(player);
		if (player.getControllerManager().getController() == null) {
			String control = null;
			if (isSafeZone(player) && !player.isUnderCombat()
					&& player.getHitpoints() < player.getMaxHitpoints())
				player.getActionManager().setAction(new Healing());
			else if (player.getRegionId() == 14994
					|| player.getRegionId() == 14995
					|| player.getRegionId() == 15251)
			...
			else if (player.getRegionId() == 13626)
				control = "Kalaboss";
			else if (!MonkeyGreeGrees.isAtApeAtoll(player)
					&& player.getRights() < 2) {
				if (player.getEquipment().getWeaponId() == 4024) {
					ButtonHandler.sendRemove(player, 3, false);
	 ...
	 * checks clip
	 */
	private static boolean isRegionLoaded(int regionId) {
		Region region = getRegion(regionId);
		if (region == null)
			return false;
	...
	public static final void turnPublic(FloorItem floorItem, int publicTime) {
		...
		for (Player player : getPlayers()) {
			...
			if ((floorItem.getName().toLowerCase().contains("toktz-xil-ul")
					...
					|| floorItem.getName().toLowerCase().contains("arrow") || floorItem
					.getName().toLowerCase().contains("bolts"))
	...
	public static final void updateGroundItem(Item item, final WorldTile tile,
		...
		if ((item.getName().toLowerCase().contains("toktz-xil-ul")
				|| item.getName().toLowerCase().contains("throwing")
				|| item.getName().toLowerCase().contains("javelin")
				|| item.getName().toLowerCase().contains("darts")
				|| item.getName().toLowerCase().contains("stake")
				|| item.getName().toLowerCase().contains("arrow") || item
				.getName().toLowerCase().contains("bolts"))
				&& owner.getEquipment().containsOneItem(26777, 26778,
						ItemIdentifiers.AVAS_ALERTER,
						ItemIdentifiers.AVAS_ACCUMULATOR,
						ItemIdentifiers.AVAS_ATTRACTOR,
						ItemIdentifiers.COMPLETIONIST_CAPE,
	...
	public static void sendEngineMessage(String message) {
		for (Player p : World.getPlayers()) {
			p.getPackets().sendGameMessage(
					"<col=FF0000>[Nocturne] " + Utils.fixChatMessage(message));
		}
	}
	...
	public static void sendNews(String message, int type, boolean discord) {
		sendNews(null, message, type, discord); // dont use type 2(FRIEND_NEWS)
												// with this
		// one
	}
	...
	public static void sendNews(Player from, String message, int type,
		...
		if (Engine.getDiscordBot() != null && discord)
			Engine.getDiscordBot().getChannel()
					.sendMessage("[News] " + message);
	}
		...
		return (tile.getY() >= 3470 && tile.getY() <= 3513
				...
				|| (tile.getX() >= 2528 && tile.getY() >= 4710
						&& tile.getX() <= 2549 && tile.getY() <= 4723) // Mage
																		// Bank
				|| (tile.getX() >= 2193 && tile.getY() >= 3346
						&& tile.getX() <= 2223 && tile.getY() <= 3376) // Prifddinas
																		// Bank
				|| (tile.withinDistance(Settings.HOME_LOCATION, 50))
	...
	public static final boolean isMultiArea(WorldTile tile) {
		...
		return (destX >= 3462 && destX <= 3511 && destY >= 9481
				...
				|| (destX >= 2172 && destX <= 2254 && destY >= 4106 && destY <= 4293) // Lucien

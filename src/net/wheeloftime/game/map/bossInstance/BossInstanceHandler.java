...
import net.wheeloftime.game.map.bossInstance.impl.*;
import net.wheeloftime.game.map.bossInstance.impl.godwars.CommanderZilyanaInstance;
import net.wheeloftime.game.map.bossInstance.impl.godwars.GeneralGraadorInstance;
import net.wheeloftime.game.map.bossInstance.impl.godwars.KreeArraInstance;
import net.wheeloftime.game.map.bossInstance.impl.godwars.KrilTsutsarothInstance;

...
import net.wheeloftime.game.player.Appearence;
import net.wheeloftime.game.player.Player;
import net.wheeloftime.utils.Utils;

public final class PlayerLook {

	public static void openCharacterCustomizing(Player player, boolean create) {
		player.getPackets().sendAppearenceLook();
		player.getPackets().sendCSVarInteger(1008, 312);
		player.getPackets().sendCSVarInteger(1009, 16);
		player.getPackets().sendCSVarInteger(1010, 869);
		player.getPackets().sendCSVarInteger(1011, -1);
		player.getPackets().sendCSVarInteger(1012, 805);
		player.getPackets().sendCSVarInteger(1013, 821);
		player.getPackets().sendCSVarInteger(1014, 837);
		player.getPackets().sendCSVarInteger(1015, 2);
		player.getPackets().sendCSVarInteger(1016, 68);
		player.getPackets().sendCSVarInteger(1017, 69);
		player.getPackets().sendCSVarInteger(1018, 197);
		player.getPackets().sendCSVarInteger(1019, 6);
		player.getPackets().sendCSVarInteger(1015, 2);
		player.getPackets().sendCSVarInteger(1016, 68);
		player.getPackets().sendCSVarInteger(1017, 69);
		player.getPackets().sendCSVarInteger(1018, 197);
		...
		player.getPackets().sendIComponentSettings(1420, 19, -1, -1, 2);
		player.getPackets().sendIComponentSettings(1420, 18, -1, -1, 2);
		player.getPackets().sendIComponentSettings(1420, 102, -1, -1, 1026);
		player.getPackets().sendIComponentSettings(1420, 186, 0, 67, 2);
		player.getPackets().sendIComponentSettings(1420, 164, 0, 46, 2);
		player.getPackets().sendIComponentSettings(1420, 432, -1, -1, 2);
		player.getPackets().sendIComponentSettings(1420, 207, -1, -1, 2);
		player.getPackets().sendIComponentSettings(1420, 596, 0, 2, 2);
		player.getPackets().sendExecuteScript(7936, new Object[] { 1 }); // confirm
																			// button
		if (!create)
			return;
		player.getPackets().sendExecuteScript(10684, new Object[] {}); // game
																		// mode
	}
	...
	public static void openYrsaShop(final Player player) {
		...
		player.getPackets().sendIComponentSettings(728, 13, 0, 300, 2);
		player.getPackets().sendIComponentSettings(728, 16, 0, 300, 2);
	...
	public static void handleYrsaShoes(Player player, int componentId,
		...
		if (componentId == 24)
			player.closeInterfaces();
		else if (componentId == 13) {// setting the colors.
			player.getAppearence().setBootsColor(
					ClientScriptMap.getMap(3297).getIntValue(slotId / 2));
			player.getAppearence().generateAppearenceData();
		} else if (componentId == 16) {// /boot style
			player.getAppearence().setBootsStyle(
					ClientScriptMap.getMap(

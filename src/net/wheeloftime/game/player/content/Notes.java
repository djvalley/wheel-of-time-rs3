...
public final class Notes implements Serializable {
	 ...
	 * @return Color ids
	 */
	private static int getPrimaryColour(Notes notes) {
		int color = 0;
		for (int i = 0; i < 16; i++) {
	 ...
	 * @return color ID
	 */
	private static int getSecondaryColour(Notes notes) {
		int color = 0;
		for (int i = 0; i < 14; i++) {
	...
	private static final class Note implements Serializable {

package net.wheeloftime.game.player.content.activities.skillertasks;

import java.io.Serializable;

import net.wheeloftime.game.player.Skills;
import net.wheeloftime.game.player.actions.skills.agility.Agility.AgilityCourses;
...
import net.wheeloftime.game.player.actions.skills.herblore.Herblore.HerbloreType;
import net.wheeloftime.game.player.actions.skills.hunter.TrapAction.Traps;
import net.wheeloftime.game.player.actions.skills.mining.Mining.RockDefinitions;
import net.wheeloftime.game.player.actions.skills.runecrafting.Runecrafting.RunecraftingTypes;
import net.wheeloftime.game.player.actions.skills.smithing.Smelting.SmeltingBar;
import net.wheeloftime.game.player.actions.skills.thieving.Thieving.ThievingTypes;

package net.wheeloftime.game.player.content.activities.dailychallenges;
	...
	public enum Tasks {
		SKILLING(
				...
				new Object[][] {
						...
						{ "Uncut dragonstone", 55, 50, 1615, 50,
								Skills.CRAFTING, 17500 },
						{ "Uncut diamond", 43, 60, 1601, 60, Skills.CRAFTING,
								15000 },
						{ "Uncut ruby", 34, 75, 1603, 75, Skills.CRAFTING,
								12500 },
						{ "Uncut emerald", 27, 80, 1605, 80, Skills.CRAFTING,
								11000 },
						{ "Uncut sapphire", 20, 90, 1607, 90, Skills.CRAFTING,
								9000 },
						{ "Uncut red topaz", 16, 110, 1613, 110,
								Skills.CRAFTING, 8200 },
						{ "Uncut jade", 13, 125, 1611, 125, Skills.CRAFTING,
								7500 },
						{ "Uncut opal", 1, 150, 1609, 150, Skills.CRAFTING,
								5000 },
						// leathers - handled
						// regular

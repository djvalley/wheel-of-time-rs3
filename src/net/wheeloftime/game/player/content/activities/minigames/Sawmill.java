...
public class Sawmill {
	...
	public static enum Plank {
		WOOD(ItemIdentifiers.PLANK, 1511, 100), OAK(ItemIdentifiers.OAK_PLANK,
				1521, 250), TEAK(ItemIdentifiers.TEAK_PLANK, 6333, 500), MAHOGANY(
				ItemIdentifiers.MAHOGANY_PLANK, 6332, 1500);

...
import net.wheeloftime.game.npc.fightcaves.FightCavesNPC;
import net.wheeloftime.game.npc.fightcaves.TzKekCaves;
import net.wheeloftime.game.npc.fightcaves.TzTok_Jad;
import net.wheeloftime.game.npc.fightcaves.Yt_HurKot;

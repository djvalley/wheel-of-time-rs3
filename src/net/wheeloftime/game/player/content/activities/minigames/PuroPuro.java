...
public class PuroPuro extends Controller {
	...
	public static void pushThrough(final Player player, WorldObject object) {
		...
		player.getPackets()
				.sendGameMessage(
						Utils.random(2) == 0 ? "You use your strength to push through the wheat in the most efficient fashion."
	...
	public static void openPuroInterface(final Player player) {
		player.getInterfaceManager().sendCentralInterface(540); // puro puro

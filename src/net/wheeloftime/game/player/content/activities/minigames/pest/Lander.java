...
import net.wheeloftime.game.player.content.activities.minigames.pest.PestControl.PestData;
...
public class Lander {
	...
	public static enum LanderRequirement {
		...
		NOVICE(40, new WorldTile(2653, 2634, 0), new WorldTile(2650, 2634, 0)),

		INTERMEDIATE(70, new WorldTile(2640, 2631, 0), new WorldTile(2637,
				2631, 0)),

		VETERAN(100, new WorldTile(2629, 2645, 0), new WorldTile(2632, 2645, 0));

package net.wheeloftime.game.player.content.activities.minigames.fistofguthix;
...
import net.wheeloftime.game.player.controllers.FistOfGuthixController;
...
public class Participant {
	...
	public void process() {
		...
		if ((FistOfGuthixController) hunter().getControllerManager()
				.getController() == null)
			hunter().getControllerManager().startController(
					"FistOfGuthixController");

		if ((FistOfGuthixController) hunted().getControllerManager()
				.getController() == null)
			hunted().getControllerManager().startController(
					"FistOfGuthixController");
	...
	public void forfeit(Player player) {
		...
		((FistOfGuthixController) winner.getControllerManager().getController())
				.exit();
		winner.getPackets()
				.sendGameMessage(
		...
		winner.getControllerManager().removeControllerWithoutCheck();
	...
	public void switchSides() {
		...
		this.hunted = p;
		if (((FistOfGuthixController) this.hunted.getControllerManager()
				.getController()) != null) {
			((FistOfGuthixController) this.hunted.getControllerManager()
					.getController()).exit();
			((FistOfGuthixController) this.hunted.getControllerManager()
					.getController()).start();
		}
		if (((FistOfGuthixController) this.hunter.getControllerManager()
				.getController()) != null) {
			((FistOfGuthixController) this.hunter.getControllerManager()
					.getController()).exit();
			((FistOfGuthixController) this.hunter.getControllerManager()
					.getController()).start();
		}
	...
	public void endGame() {
		...
		if ((FistOfGuthixController) hunted().getControllerManager()
				.getController() != null)
			((FistOfGuthixController) hunted().getControllerManager()
					.getController()).exit();
		if ((FistOfGuthixController) hunter().getControllerManager()
				.getController() != null)
			((FistOfGuthixController) hunter().getControllerManager()
					.getController()).exit();
		hunter().getControllerManager().removeControllerWithoutCheck();
		hunted().getControllerManager().removeControllerWithoutCheck();

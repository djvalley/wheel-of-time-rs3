package net.wheeloftime.game.player.content.lending;
...
public class LendReturn extends Dialogue {
	 ...
	 * 
	 * @Override public void run(int interfaceId, int componentId, int slotId)
	 * throws ClassNotFoundException, IOException { if (stage == -1) { if
	 * (componentId == 10) { sendOptionsDialogue("Really give back?",

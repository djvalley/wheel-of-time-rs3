...
public class DungeonRewardShop {
	...
	private static boolean canPurchase(Player player) {
		...
		GeneralRequirementMap.getMap(slot);
	...
	public enum DungeonReward {
		...
		XP_LAMP(23749, 0, 1, 8000), RING_OF_KINSHIP_RESET(15707, 5, 1, 1), HOARDWALKER_RING(
				...
				18342, 80, 45, 10000), GRAVITE_RAPIER(18365, 85, 45, 40000), OFFHAND_GRAVITE_RAPIER(
				36869, 95, 45, 40000), GRAVITE_LONGSWORD(18367, 90, 45, 40000), OFFHAND_GRAVITE_LONGSWORD(
				36871, 95, 45, 40000), GRAVITE_2H(18369, 95, 45, 40000), GRAVITE_STAFF(
				18371, 100, 45, 40000), GRAVITE_SHORTBOW(18373, 105, 45, 40000), GRAVITE_KNIFE(
				36877, 95, 45, 40000), OFFHAND_GRAVITE_KNIFE(36879, 95, 45,
				20000), GRAVITE_WAND(36873, 95, 45, 40000), GRAVITE_ORB(36875,
				95, 45, 20000), TOME_OF_FROST(18346, 110, 48, 43000), AMULET_OF_ZEALOTS(
				19892, 115, 45, 40000), SCROLL_OF_CLEANSING(19890, 120, 49,
				20000), SPIRIT_CAPE(19893, 125, 50, 45000), NATURE_STAFF(18341,
				130, 53, 12000), SCROLL_OF_EFFICIENCY(19670, 135, 55, 20000), ARCANE_BLAST_NECKLACE(
				18334, 140, 50, 15500), FARSIGHT_SNAP_SHOT_NECKLACE(31444, 145,
				50, 15500), BRAWLERS_HOOK_NECKLACE(31447, 150, 50, 15500), SPLIT_DRAGONTOOTH_NECKLACE(
				19887, 155, 60, 17000), ANTI_POISON_TOTEM(18340, 160, 60, 44000), SCROLL_OF_PROFICIENCY(
				19670, 165, 60, 20000), SCROLL_OF_DEXTERITY(31452, 170, 60,
				20000), GOLD_ACCUMULATOR(31453, 175, 1, 20000), GOLD_ACCUMULATOR_OVERCHARGE(
				36873, 95, 45, 40000), RING_OF_VIGOUR(19669, 180, 62, 50000), SCROLL_OF_RENEWAL(
				18343, 185, 65, 38000), SCROLL_OF_DAEMONHEIM(31450190, 190, 70,
				30000), MERCENARY_GLOVES(18347, 195, 73, 48500), CHAOTIC_SPIKE(
				27068, 200, 80, 20000), CHAOTIC_REMANT(31449, 205, 80, 100000), CHAOTIC_RAPIER(
				...
				200000), FARSEER_KITESHIELD(18363, 265, 80, 200000), CHAOTIC_SPLINT(
				36164, 265, 80, 150000), DEMON_HORN_NECKLACE(19888, 270, 90,
				35000), FROSTY(31459, 275, 99, 250000), MINI_BLINK(31457, 280,
				99, 500000), HOPE_NIBBLER(31458, 285, 101, 1000000), MEILYR_POTION_RECIPE(
				31796, 265, 80, 500000);

package net.wheeloftime.game.player.actions.skills.thieving;
...
public enum PickPocketableNPC {
	...
	MAN(new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 170, 7875, 7876, 7882, 7879 },
			new byte[] { 1, 11, 21, 31 }, new byte[] { 1, 11, 21, 31 }, 8.0, 4,
			10, new Item(995, 10)),

	POMPOUS_MERCHANT(new short[] { 23104 }, new byte[] { 1, 11, 21, 31 },
			new byte[] { 1, 11, 21, 31 }, 8.0, 4, 10, new Item(995, 8)),

	WAIKO_ISLANDER(new short[] { 23457, 23458, 23459, 23460 }, new byte[] { 1,
			11, 21, 31 }, new byte[] { 1, 11, 21, 31 }, 8.0, 4, 10, new Item(
			995, 100)),

	DESERT_PHOENIX(new short[] { 1911 }, new byte[] { 1, 127, 127, 127 },
			new byte[] { 1, 1, 1, 1 }, 26, 4, 15, new Item(4621, 1)),
	/**
	 ...
	 */
	MASTER_FARMER(new short[] { 3299, 2234, 2235 },
			new byte[] { 38, 48, 58, 68 }, new byte[] { 1, 38, 48, 58 }, 43, 4,
			30, new Item(5096), new Item(5097), new Item(5098), new Item(5099),
			new Item(5100), new Item(5101), new Item(5102), new Item(5103),
			new Item(5104), new Item(5105), new Item(5106), new Item(5291),
			new Item(5292), new Item(5293), new Item(5294), new Item(5295),
			new Item(5296), new Item(5297), new Item(5298), new Item(5299),
			new Item(5300), new Item(5301), new Item(5302), new Item(5304),
			new Item(5305), new Item(5306), new Item(5307), new Item(5308),
			new Item(5309), new Item(5310), new Item(5311), new Item(5312),
			new Item(5318), new Item(5319), new Item(5320), new Item(5321),
	...
	GNOME(new short[] { 66, 67, 68, 168, 169, 2249, 2250, 2251, 2371, 2649,
			2650, 6002, 6004, 159, 160, 161 }, new byte[] { 75, 85, 95, 105 },
			new byte[] { 1, 75, 85, 95 }, 198.5, 4, 10, new Item(995, 300),
			new Item(557), new Item(444), new Item(569), new Item(2150),
			new Item(2162)),
	 ...
	 * Elves.
	 */
	ELVES(new short[] { 2363, 2364, 2365, 2366, 2367 }, new byte[] { 85, 95,
			105, 115 }, new byte[] { 1, 85, 95, 105 }, 353.3, 5, 50, new Item(
			995, 5), new Item(995, 5), new Item(995, 5), new Item(1993, 1),
			new Item(560, 2), new Item(561, 3), new Item(569, 1), new Item(444,
					1)),
	 ...
	 *            The possible loot.
	 */
	PickPocketableNPC(short[] npcIds, byte[] thievingLevel,

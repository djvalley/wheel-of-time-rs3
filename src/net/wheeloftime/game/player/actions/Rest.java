...
public class Rest extends Action {
	...
	private static final int[][] FIRST = { { 5713, 1549, 5748 },
			{ 11786, 1550, 11788 }, { 5713, 1551, 2921 } }; // Normal

	private static final int[][] SECOND = { { 20286, 20287, 20288 },
			{ 20286, 20287, 20288 }, { 20286, 20287, 20288 } }; // Arcane

	private static final int[] SECOND_GFX = { 4003, 4004, 4005 };

	private static final int[][] THIRD = { { 17301, 17302, 17303 },
			{ 17301, 17302, 17303 }, { 17301, 17302, 17303 } }; // Zen

	private int index;
	private final boolean musician;

...
public class HintIconsManager {
	...
	public int addHintIcon(int index, Entity target, int arrowType,
	...
	public int addHintIcon(WorldTile tile, int distanceFromFloor,
			int direction, int arrowType, int modelId, boolean saveIcon) {
		return addHintIcon(tile.getX(), tile.getY(), tile.getPlane(),
				distanceFromFloor, direction, arrowType, modelId, saveIcon);
	}

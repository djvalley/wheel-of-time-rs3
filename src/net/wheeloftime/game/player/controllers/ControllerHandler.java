...
import net.wheeloftime.game.player.content.activities.minigames.BrimhavenAgility;
...
import net.wheeloftime.game.player.content.activities.minigames.PyramidPlunder;
...
import net.wheeloftime.game.player.content.activities.minigames.riseofthesix.RiseOfTheSix;
...
import net.wheeloftime.game.player.content.activities.surpriseevents.LastManStandingController;
import net.wheeloftime.game.player.content.activities.surpriseevents.TeamVsTeamController;
import net.wheeloftime.game.player.controllers.bossInstance.BossInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.CorporealBeastInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.DagannothKingsInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.EvilChickenInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.KalphiteKingInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.KalphiteQueenInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.RiseOfTheSixController;
import net.wheeloftime.game.player.controllers.bossInstance.VoragoInstanceController;
import net.wheeloftime.game.player.controllers.bossInstance.godwars.GeneralGraadorInstanceController;
...
import net.wheeloftime.game.player.controllers.fightpits.FightPitsArena;
import net.wheeloftime.game.player.controllers.fightpits.FightPitsLobby;
...
import net.wheeloftime.game.player.controllers.trollinvasion.TrollInvasion;

 ...
 */
package net.wheeloftime.game.player.controllers.soulwars;
...
public class SoulWarsController extends Controller {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.wheeloftime.game.player.Controllers.Controller#start()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.wheeloftime.game.player.Controllers.Controller#sendInterfaces()
	 */
	/**
	 * Send sw interfaces.
	 */
	 ...
	 * 
	 * @see
	 * net.wheeloftime.game.player.Controllers.Controller#processButtonClick(int,
	 * int, int, int)
	 */
	 ...
	 * 
	 * @see
	 * net.wheeloftime.game.player.Controllers.Controller#processMagicTeleport(net.
	 ...
	 * 
	 * @see
	 * net.wheeloftime.game.player.Controllers.Controller#processObjectClick1(net
	 * .DragonInf3 .game.WorldObject)
	 */
	 ...
	 * 
	 * @see
	 * net.wheeloftime.game.player.Controllers.Controller#canHit(net.wheeloftime.game
	 * .Entity )
	 */
	 ...
	 * 
	 * @see
	 * net.wheeloftime.game.player.Controllers.Controller#canAttack(net.wheeloftime
	 * .game .Entity)
	 */

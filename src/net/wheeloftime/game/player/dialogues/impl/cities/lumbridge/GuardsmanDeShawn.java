package net.wheeloftime.game.player.dialogues.impl.cities.lumbridge;

import net.wheeloftime.game.player.dialogues.Dialogue;

/**
 * The class that represents the dialogue for the NPC - Guardsman DeShawn
 * 
 * @author Mod Austin
...
public class GuardsmanDeShawn extends Dialogue {

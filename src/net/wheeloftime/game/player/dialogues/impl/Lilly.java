...
public class Lilly extends Dialogue {
	...
	public void start() {
		sendNPCDialogue(npcId, NORMAL,
				"Uhh... hi... didn't see ya there. Can.... I help you?");
	}
	...
	public void run(int interfaceId, int componentId, int slotId) {
		if (stage == -1) {
			...
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE,
					...
					"That's a pretty wall hanging.", "Bye!");
			stage = 2;
		} else if (stage == 2) {
			...
			sendPlayerDialogue(NORMAL,
					"Really? Is that why there is all this cloth and die lying around?");
			stage = 6;
		} else if (stage == 6) {
			sendNPCDialogue(npcId, NORMAL,
					"Yes, it is a hobby of mine when I'm.... relaxing.");
			stage = 7;
		} else if (stage == 7) {
			end();
		} else if (stage == 8) {

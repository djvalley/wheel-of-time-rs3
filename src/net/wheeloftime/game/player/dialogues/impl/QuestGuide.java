...
import net.wheeloftime.game.player.controllers.NewSpawnPlayerController;
import net.wheeloftime.game.player.dialogues.Dialogue;

public class QuestGuide extends Dialogue {

	int npcId;
	NewSpawnPlayerController Controller;

	@Override
	public void start() {
		npcId = (Integer) parameters[0];
		Controller = (NewSpawnPlayerController) parameters[1];
		if (Controller == null) {

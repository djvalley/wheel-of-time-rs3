package net.wheeloftime.game.player.dialogues.impl.shos;
...
public class StrongHoldOfSecurityRewards extends Dialogue {
	...
	public void run(int interfaceId, int componentId, int slotId) {
		if (stage == -1) {
			...
			sendOptionsDialogue("Choose your style of boots",
					"I'll take the colourful ones.",
					"I'll take the fighting ones.");
			stage = 3;
		} else if (stage == 3) {
			boolean fancy = componentId == OPTION_1;
			sendPlayerDialogue(9827, fancy ? "I'll take the colourful ones."
					: "I'll take teh fighting ones.");
			...
			if (reward == 0) {
				...
				player.getInventory().addItemMoneyPouch(new Item(995, 30000));

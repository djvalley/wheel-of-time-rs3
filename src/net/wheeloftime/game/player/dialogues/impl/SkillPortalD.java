...
public class SkillPortalD extends Dialogue {
	...
	public void run(int interfaceId, int componentId, int slotId)
		...
		case 3:
			...
			case OPTION_1:
				 ...
				 * price); player.getVarsManager().sendVarBit(25054, 1); stage =
				 * 9;
				 */
			...
			case OPTION_2:
				...
				player.getVarsManager().sendVarBit(25054, 2);
				player.getVarbits().put(25054, 2);
				stage = 9;
				break;
			case OPTION_3:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 3);
				player.getVarbits().put(25054, 3);
				stage = 9;
				break;
			case OPTION_4:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 4);
				player.getVarbits().put(25054, 4);
				stage = 9;
				break;
			case OPTION_5:
				sendOptionsDialogue(
		...
		case 4:
			...
			case OPTION_1:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 5);
				player.getVarbits().put(25054, 5);
				stage = 9;
				break;
			case OPTION_2:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 6);
				player.getVarbits().put(25054, 6);
				stage = 9;
				break;
			case OPTION_3:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 7);
				player.getVarbits().put(25054, 7);
				stage = 9;
				break;
			case OPTION_4:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 8);
				player.getVarbits().put(25054, 8);
				stage = 9;
				break;
		...
		case 7:
			...
			case OPTION_1:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 9);
				player.getVarbits().put(25054, 9);
				stage = 9;
				break;
			case OPTION_2:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 10);
				player.getVarbits().put(25054, 10);
				stage = 9;
				break;
			case OPTION_3:
				...
				player.getInventory()
						.removeItemMoneyPouch(new Item(995, price));
				player.getVarsManager().sendVarBit(25054, 11);
				player.getVarbits().put(25054, 11);
				stage = 9;
				break;
			case OPTION_4:
				end();

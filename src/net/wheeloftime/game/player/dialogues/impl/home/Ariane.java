...
public class Ariane extends Dialogue {
	...
	public void run(int interfaceId, int componentId, int slotId) {
		switch (stage) {
		case -1:
			sendOptionsDialogue("<col=FF0000>Locations", "Monster Locations",
					"Minigame Locations", "Skilling Locations", "None");
			stage = 1;
			break;
		case 1:
			switch (componentId) {
			...
			case OPTION_3:
				sendNPCDialogue(npcId, NORMAL,
						"To open a skill's teleport menu, please click the skill in the stats bar.");
				stage = 50;
				break;
			case OPTION_4:
				end();
		...
		case 10:
			...
			case OPTION_2:
				sendOptionsDialogue("<col=FF0000>Woodcutting Locations",
						"Seers' Village", "Daemonheim", "Varrock Palace");
				stage = 103;
				break;
			case OPTION_3:
		...
		case 102:
			...
			case OPTION_3:
				...
				Magic.sendSkyJumpTeleport(player, new WorldTile(3000, 3910, 0));
				end();
				break;
			case OPTION_4:
				if (npc != null) {
				...
				Magic.sendSkyJumpTeleport(player, new WorldTile(2178, 3397, 1));
				end();
				break;
			}
			break;
		...
		case 103:
			...
			case OPTION_1:
				...
				Magic.sendSkyJumpTeleport(player, new WorldTile(2706, 3483, 0));
				end();
				break;
			case OPTION_2:
				if (npc != null) {
				...
				Magic.sendSkyJumpTeleport(player, new WorldTile(3493, 3611, 0));
				end();
				break;
			case OPTION_3:
				if (npc != null) {
				...
				Magic.sendSkyJumpTeleport(player, new WorldTile(3218, 3503, 0));
				end();
				break;
			}
			break;
		...
		case 105:
			...
			case OPTION_2:
				sendNPCDialogue(npcId, LAUGHING,
						"Nice Try!  do ;;div[WispType] for those teleports!");
				stage = 50;
				break;
			case OPTION_3:
				sendOptionsDialogue("<col=FF0000>Skilling Locations",
		...
		case 9:
			...
			case OPTION_5:
				stage = 15;
				sendOptionsDialogue("<col=FF0000>Minigames Locations",
						"Pyramid Plunder", "Troll Invasion", "Duel Arena",
						"Runespan", "Back");
			}
			break;
		...
		case 15:
			...
			case OPTION_3:
				...
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3211,
						3233, 0));
				end();
				break;
			case OPTION_4:
				Magic.sendLunarTeleportSpell(player, 0, 0, new WorldTile(3101,
						3154, 2));
			case OPTION_5:
				stage = 9;
				sendOptionsDialogue("<col=FF0000>Minigames Locations",
		...
		case 7:
			...
			case OPTION_5:
				stage = 16;
				sendOptionsDialogue("<col=FF0000>Boss Locations",
						"Revenants <col=FF0000>(Wilderness)", "Bork",
						"Evil Chicken", "Back");
				break;
			}
			break;

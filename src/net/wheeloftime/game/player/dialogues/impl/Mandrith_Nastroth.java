...
public class Mandrith_Nastroth extends Dialogue {
	...
	public static int ARTEFACTS[] = new int[] { 14876, 14877, 14878, 14879,
	...
	public void run(int interfaceId, int componentId, int slotId) {
		...
		case 6:
			...
			sendNPCDialogue(
					npcId,
					9827,
					"You like not my kingly robes? They were my father's and his father's before him, and his father's before him, and his father's before him, and-");
			break;
		case 7:
			stage = -2;
		...
		case 22:
			...
			for (int i : ARTEFACTS) {
				...
				if (amt != 0) {
					coins += ItemDefinitions.getItemDefinitions(i).getPrice()
							* amt;
					player.getInventory().deleteItem(i, amt);
				}
			}
			player.getInventory().addItemMoneyPouch(new Item(995, coins));

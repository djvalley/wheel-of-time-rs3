	...
	public void run(int interfaceId, int componentId, int slotId) {
		...
		if (stage == 0)
			sendNPCDialogue(
					npcId,
					NORMAL,
					"Urrrgggh....I'll be OK, the trolls only leave the platue at nightfall. The guys are bringing a strecher shortly.");
		else if (stage == 1)
			...
			sendNPCDialogue(
					npcId,
					NORMAL,
					"It's my own fault really, I was having a walk and wandered too far past the danger sign. THe trollows throug hrocks down at anyone who goes up the path!");
		else if (stage == 3)

		...
		case 3:
			...
			case OPTION_1:
				...
				sendNPCDialogue(
						npcId,
						HAPPY,
						"Warbands are a wilderness activity that occur hourly, here at Nocturne. The objective of the minigame is to siphon the obelisk in the center of the camp undetected, then once having done so, loot the resources from within the camp.");
				break;
			case OPTION_2:
				stage = 2;
				sendNPCDialogue(

package net.wheeloftime.game.npc.clans;
...
import net.wheeloftime.game.npc.NPCCustomizationData;
import net.wheeloftime.game.player.Player;
import net.wheeloftime.game.player.content.activities.clans.Clan;
...
public class ClanVexillum extends NPC {
	...
	public static void openPlayerClanDetails(Player reader) {
		if (reader == null || reader.getClanManager().getClan() == null || reader.getClanManager().getClan().getClanPlanterUsername() == null || World.getPlayer(reader.getClanManager().getClan().getClanPlanterUsername()) == null)
			return;
		Player player = World.getPlayer(reader.getClanManager().getClan().getClanPlanterUsername());

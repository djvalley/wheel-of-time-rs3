...
public class Spiritpengitrice extends Familiar {
	...
	public Spiritpengitrice(Player owner, Pouch pouch, WorldTile tile,
	...
	public boolean submitSpecial(Object object) {
		...
		if (target instanceof Player) {
			...
			int level = playerTarget.getSkills().getLevel(Skills.RANGED);
			int drained = 3;
			if (level - drained > 0)
				drained = level;
			playerTarget.getSkills().drainLevel(Skills.RANGED, drained);
		}

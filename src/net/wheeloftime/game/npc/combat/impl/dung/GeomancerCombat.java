...
import net.wheeloftime.game.npc.dungeonnering.HobgoblinGeomancer;
import net.wheeloftime.game.player.Player;
import net.wheeloftime.game.player.Skills;
import net.wheeloftime.game.player.actions.skills.dungeoneering.*;
			...
			if (damage > 0) {
				if (t instanceof Player) {
					...
					if (player.getPrayer().hasPrayersOn()) {
						if (!hasDrained) {
							int prayerPoints = player.getPrayer().getPoints();

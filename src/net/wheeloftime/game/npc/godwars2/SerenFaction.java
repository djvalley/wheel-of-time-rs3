...
public class SerenFaction extends NPC {

	public SerenFaction(int id, WorldTile tile, int mapAreaNameHash,
				...
				if (loop == 0) {
					...
					if (source instanceof Player) {
						...
						Controller Controller = player.getControllerManager()
								.getController();
						if (Controller != null && Controller instanceof GodWars2) {

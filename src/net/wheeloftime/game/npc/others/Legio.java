...
import net.wheeloftime.game.player.controllers.AscensionDungeon;
...
public class Legio extends NPC {
	...
	private static WorldTile getSpawnTile(int index) {
		switch (index) {
		case 0:
	...
	public void sendDeath(final Entity source) {
		if (source instanceof Player)
			((Player) source).getTimersManager()
					.removeTimer(RecordKey.LEGIONES);
	...
	private WorldTile findClosestFreeTile() {

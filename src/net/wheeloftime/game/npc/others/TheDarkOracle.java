...
public class TheDarkOracle extends NPC {
	...
	static {
		...
		/* colored sols */
		dList[Drops.COMMON].add(new Drop(22207, 1, 1));
		dList[Drops.COMMON].add(new Drop(22209, 1, 1));
		dList[Drops.COMMON].add(new Drop(22211, 1, 1));
		dList[Drops.COMMON].add(new Drop(22213, 1, 1));
		/* colored whips */
		dList[Drops.COMMON].add(new Drop(15441, 1, 1));
		dList[Drops.COMMON].add(new Drop(15442, 1, 1));
		dList[Drops.COMMON].add(new Drop(15443, 1, 1));
		dList[Drops.COMMON].add(new Drop(15444, 1, 1));
	...
	public Item sendDrop(Player player, Drop drop) {
		...
		Item item = ItemDefinitions.getItemDefinitions(drop.getItemId())
				.isStackable() ? new Item(drop.getItemId(), drop.getMinAmount()

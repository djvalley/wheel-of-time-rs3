package net.wheeloftime.game.route.strategy;
...
public class ObjectStrategy extends RouteStrategy {
	...
	public ObjectStrategy(WorldObject object) {
		...
		this.sizeX = id == 88063 ? 1 : rotation == 0 || rotation == 2 ? object
				.getDefinitions().getSizeX() : object.getDefinitions()
				.getSizeY();
		this.sizeY = id == 88063 ? 4 : rotation == 0 || rotation == 2 ? object
				.getDefinitions().getSizeY() : object.getDefinitions()
				.getSizeX();

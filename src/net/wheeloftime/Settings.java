...
public final class Settings {
	...
	public static final String HOST_IP = HOSTED ? "71.95.73.127"
			: "127.0.0.1";

	public static final String UPDATE_TOPIC_TITLE = "";
	public static final String UPDATE_TOPIC_ID = "";
	public static final String SERVER_NAME = "Wheel of Time";
	public static final String MAIN_FC = "Straken";
	...
	public static final InetSocketAddress GAME_ADDRESS_BASE = new InetSocketAddress(43593);
	...
	static void init() {
		...
		LOGIN_CLIENT_ADDRESS_BASE = new InetSocketAddress(
			...
			WORLDS_INFORMATION = new WorldInformation[] {
					new WorldInformation(1, 0, "World1", 0, 0x2 | 0x8, "World 1", "71.95.73.127", 100),
					new WorldInformation(2, 0, "World2", 0, 0x2 | 0x8, "World 2", "71.95.73.127", 100),};
	}
	...
	public static String getDropboxLocation() {
		...
		return host.equalsIgnoreCase("Miles") ? "D:/Dropbox/" : "data/logs/";
	}

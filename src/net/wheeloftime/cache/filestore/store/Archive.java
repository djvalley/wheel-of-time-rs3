...
import net.wheeloftime.cache.filestore.util.bzip2.BZip2Compressor;
import net.wheeloftime.cache.filestore.util.bzip2.BZip2Decompressor;
import net.wheeloftime.cache.filestore.util.crc32.CRC32HGenerator;
import net.wheeloftime.cache.filestore.util.gzip.GZipCompressor;
import net.wheeloftime.cache.filestore.util.gzip.GZipDecompressor;

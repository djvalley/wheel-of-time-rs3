...
public class RenderAnimDefinitions {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * RenderAnimDefinitions
		 * .getRenderAnimDefinitions(NPCDefinitions.getNPCDefinitions
		 * (i).renderEmote); if (defs != null) { writer.write(i + ", run: " +
		 * defs.runAnimation + ", walk: " + defs.walkAnimation + ", stand: " +
		 * Arrays.toString(defs.anIntArray967)); writer.newLine();
